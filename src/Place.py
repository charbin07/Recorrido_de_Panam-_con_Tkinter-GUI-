...
Cocle.AddZone(Place("Valle de Anton", "../res/provincias/Cocle/zonas/descr/valle_de_anton.txt","../res/provincias/Cocle/zonas/img/valle_de_anton.png"))
#zonas de colon
Colon.AddZone(Place("Fuerte San Lorenzo", "../res/provincias/Colon/zonas/descr/Fuerte_San_Lorenzo.txt","../res/provincias/Colon/zonas/img/Fuerte_san_lorenzo .png"))
Colon.AddZone(Place("Gamboa", "../res/provincias/Colon/zonas/descr/Gamboa.txt","../res/provincias/Colon/zonas/img/Gamboa.png"))
Colon.AddZone(Place("Lago Gatun", "../res/provincias/Colon/zonas/descr/lago_gatun.txt","../res/provincias/Colon/zonas/img/Lago_gatun.png"))
Colon.AddZone(Place("Portobelo", "../res/provincias/Colon/zonas/descr/portobelo.txt","../res/provincias/Colon/zonas/img/Portobelo.png"))
