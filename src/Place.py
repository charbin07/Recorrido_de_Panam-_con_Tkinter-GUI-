...
#zonas de Bocas
Bocas.AddZone(Place("Bastimento","/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/BocasDelToro/zonas/descr/Bastimento.txt",""))
Bocas.AddZone(Place("Isla colon", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/BocasDelToro/zonas/descr/isla_colon.txt",""))
Bocas.AddZone(Place("Isla solarte", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/BocasDelToro/zonas/descr/isla_solarte.txt",""))
Bocas.AddZone(Place("Playa estrella", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/BocasDelToro/zonas/descr/playa_estrella.txt",""))
#zonas de chiriqui
Chiriqui.AddZone(Place("Bajo Boquete", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Chiriqui/zonas/descr/Bajo_Boquete.txt", ""))
Chiriqui.AddZone(Place("Cerro punta", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Chiriqui/zonas/descr/Cerro_Punta.txt", ""))
Chiriqui.AddZone(Place("David", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Chiriqui/zonas/descr/David.txt", ""))
Chiriqui.AddZone(Place("Las lajas", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Chiriqui/zonas/descr/Las_Lajas.txt",""))
#zonas de cocle
Cocle.AddZone(Place("La india dormida", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Cocle/zonas/descr/india_dormida.txt",""))
Cocle.AddZone(Place("Museo del caño", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Cocle/zonas/descr/museo_del_caño.txt",""))
Cocle.AddZone(Place("Playa Farallon", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Cocle/zonas/descr/playa_farallon.txt",""))
Cocle.AddZone(Place("Valle de Anton", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Cocle/zonas/descr/valle_de_anton.txt",""))
#zonas de colon
Colon.AddZone(Place("Fuerte San Lorenzo", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Colon/zonas/descr/Fuerte_San_Lorenzo.txt",""))
Colon.AddZone(Place("Gamboa", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Colon/zonas/descr/Gamboa.txt",""))
Colon.AddZone(Place("Lago Gatun", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Colon/zonas/descr/lago_gatun.txt",""))
Colon.AddZone(Place("Portobelo", "/home/charbin07/PycharmProjects/Python/Prueba de tkinter/res/provincias/Colon/zonas/descr/portobelo.txt",""))
