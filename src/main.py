...
class MainMenu(tk.Frame):
    def __init__(self, master):
        ...
        self.canvas.pack()
        #dibujar bg
        bgLabel = tk.Label(self, image=bgMap)
        bgLabel.image = bgMap
    ...
    def BotonesMapa(self):
        boc = tk.Button(self.master, text="Bocas del toro", command=lambda: self.master.switch_frame(PageOne))
        boc.place(x=40, y=75)
        ...
        dar = tk.Button(self.master, text="Darién")
        dar.place(x=1000, y=290)
        her = tk.Button(self.master, text="Herrera")
        her.place(x=470, y=350)
        ls = tk.Button(self.master, text="Los Santos")
        ls.place(x=510, y=450)
