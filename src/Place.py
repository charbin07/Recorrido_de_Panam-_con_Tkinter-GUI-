...
# Colon = Place("Colon", "../res/provincias/Colon/Colon.txt", "")
# Cocle = Place("Cocle", "../res/provincias/Cocle/cocle.txt", "")
# Chiriqui = Place("Chiriqui", "../res/provincias/Chiriqui/Chiriqui.txt", "")
# Bocas = Place("Bocas del Toro", "../res/provincias/BocasDelToro/Bocas_del_toro.txt", "")
