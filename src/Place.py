...
Darien = Place("Darién", "../res/provincias/Darien/Darien.txt", "../res/provincias/Darien/darien-Mapa.png")
Panama = Place("Panamá", "../res/provincias/Panama/panama.txt", "../res/provincias/Panama/panama.png")
PanamaOeste = Place("Panamá Oeste", "../res/provincias/PanamaOeste/panamaOeste.txt", "../res/provincias/PanamaOeste/panamaOeste-mapa.png")
Veraguas = Place("Veraguas", "../res/provincias/Veraguas/veraguas.txt", "../res/provincias/Veraguas/veraguas-mapa.png")
Colon = Place("Colón", "../res/provincias/Colon/Colon.txt","../res/provincias/Colon/Mapa_de_Colon.png")
Cocle = Place("Coclé", "../res/provincias/Cocle/cocle.txt","../res/provincias/Cocle/Mapa_de_Cocle.png")
Chiriqui = Place("Chiriquí", "../res/provincias/Chiriqui/Chiriqui.txt","../res/provincias/Chiriqui/Mapa_de_Chiriqui.png")
Bocas = Place("Bocas del Toro", "../res/provincias/BocasDelToro/Bocas_del_toro.txt","../res/provincias/BocasDelToro/Bocas_del_Toro.png")

#comarcas
Embera = Place("Emberá", "../res/comarcas/Embera/comarca-Embera.txt", "../res/comarcas/Embera/Embera.png")
...
#zonas de Panama
Panama.AddZone(Place("Causeway Amador", "../res/provincias/Panama/zonas/decr/amador.txt", "../res/provincias/Panama/zonas/img/cosweyAmador.png", 1450.0))
Panama.AddZone(Place("Canal de Panamá", "../res/provincias/Panama/zonas/decr/canaldepanama.txt", "../res/provincias/Panama/zonas/img/canaldepanama.png", 1200.0))
Panama.AddZone(Place("Panamá La Vieja", "../res/provincias/Panama/zonas/decr/panamaLavieja.txt", "../res/provincias/Panama/zonas/img/panamaLavieja.png", 1400.0))
...
PanamaOeste.AddZone(Place("Chicá", "../res/provincias/PanamaOeste/zonas/descr/chica.txt", "../res/provincias/PanamaOeste/zonas/img/chica.png", 650.0))
PanamaOeste.AddZone(Place("Laguna de San Carlos", "../res/provincias/PanamaOeste/zonas/descr/lagunaSanCarlos.txt", "../res/provincias/PanamaOeste/zonas/img/lagunaSanCarlos.png", 1200.0))
...
Darien.AddZone(Place("Parque Nacional Darién", "../res/provincias/Darien/zonas/descr/parqueNacionalDarien.txt", "../res/provincias/Darien/zonas/img/parqueNacionalDarien.png", 400.0))
...
Herrera.AddZone(Place("El Cenegón", "../res/provincias/Herrera/zonas/descr/elCenegon.txt", "../res/provincias/Herrera/zonas/img/elCenegon.png", 600.0))
...
Bocas.AddZone(Place("Isla colón", "../res/provincias/BocasDelToro/zonas/descr/isla_colon.txt", "../res/provincias/BocasDelToro/zonas/imagenes/isla_colon_bocas.png", 3000.0))
...
Colon.AddZone(Place("Lago Gatún", "../res/provincias/Colon/zonas/descr/lago_gatun.txt","../res/provincias/Colon/zonas/img/Lago_gatun.png", 1200.0))
